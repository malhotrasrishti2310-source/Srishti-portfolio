        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="text-left lg:col-span-7">
            ...
            <div className="mt-8 flex flex-wrap gap-4 font-sans text-sm font-medium">
             ...
             <a
  href="#contact"
  className="rounded-full border-2 border-black bg-white px-7 py-3.5 font-bold text-black shadow-md transition-all duration-300 hover:-translate-y-1 hover:bg-black hover:text-white dark:border-white dark:bg-black dark:text-white dark:hover:bg-white dark:hover:text-black"
>
  Contact Me
</a>
            </div>
